...
- [BIOS CRC32 Patcher](tools/biosCRC32Patcher.htm)
- [`bnister`'s Bootloader Patch](sf2000/firmware.md#bootloader-bug)
- [Boot Logo Changer](tools/bootLogoChanger.htm)
- [Button Mapping Tool](tools/buttonMappingChanger.htm)
...
- [Firmware Version Checker](tools/firmwareVersionChecker.htm)
- [FROGTOOL](https://github.com/tzlion/frogtool) (for updating the built-in game lists)
- [Generic Image Tool](tools/genericImageTool.htm)
...
- [Save State Tool](tools/saveStateTool.htm)
